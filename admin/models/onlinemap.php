...
/**
 * Onlinemap Model for PVCFManager Component
 *
 * @package    Philadelphia.Votes
 * @subpackage Components
 * @license    GNU/GPL
 */
class PvcfmanagerModelOnlinemap extends JModel
{
    /**
    ...
    public function store($data)
    {
        ...
        // Bind the form fields to the Onlinemap table
        if (!$row->bind($data)) {
            $this->setError($this->_db->getErrorMsg());
            return false;
        }

        // Make sure the Onlinemap record is valid
        if (!$row->check()) {
            //$this->setError($this->_db->getErrorMsg());
