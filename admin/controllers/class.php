...
/**
 * Class Controller for PVCFManager Component
 *
 * @package    Philadelphia.Votes
 * @subpackage Components
 * @license    GNU/GPL
 */
class PvcfmanagerControllerClass extends PvcfmanagerController
{
    /**
    ...
    public function save()
    {
        ...
        $record_url = 'index.php?option=com_pvcfmanager&controller=class&task=edit&cid[]=';

        $link = 'index.php?option=com_pvcfmanager&controller=classes';
        ...
        if (JRequest::getVar('save_and_new')) {
            $link = 'index.php?option=com_pvcfmanager&controller=class&task=add';
        }
    ...
    public function remove()
    {
        ...
        $this->setRedirect('index.php?option=com_pvcfmanager&controller=classes', $msg);
    }
