    ...
    <table cellpadding="0" cellspacing="0" border="0" class="adminform">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="filename" name="filename" size="62" value="<?=$row->filename ? $row->filename : $row['filename'];?>" class="input_box required" maxlength="60" classholder="<?=JText::_('FILENAME PLACEHOLDER');?>" />
                </td>
            </tr>
            <tr>
                <td width="200" height="30">
                ...
                <td>
                    <input type="text" id="typepath" name="typepath" size="62" value="<?=$row->typepath ? $row->typepath : $row['typepath'];?>" class="input_box required" maxlength="60" classholder="<?=JText::_('TYPEPATH PLACEHOLDER');?>" />
                </td>
            </tr>
            <tr>
                <td width="200" height="30">
